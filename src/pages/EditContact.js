  ...
  return (
    <>
      {loading ? (
        ...
        <Container
          id='edit'
          className=' d-flex edit-contact-wrapper mt-5 w-100  justify-content-center align-items-center'
        >
          <Row
            className='  border border-success border border-2 rounded shadow bg-body rounded position-relative my-5 d-flex flex-column w-50  pb-5 px-5'
            id='edit-contact'
          >
            <Col>
